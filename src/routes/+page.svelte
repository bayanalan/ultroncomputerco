...
<div class="w-full text-center">
  <a class=" poppins btn glass mt-6 rounded-full bg-white text-black hover:shadow-xl " href="https://www.amazon.com/hz/wishlist/ls/W7807HTP7TBW?ref_=wl_share" target="_blank">Dream PC Wishlist</a>
</div>
...
<div class="w-full text-center">
  <a class="poppins shadow-xl btn glass mt-6 rounded-full bg-white text-black hover:shadow-xl" href="https://www.youtube.com/channel/UCNO7sfAI3CiN59y2vDt2dVw" target="_blank">Youtube</a>
